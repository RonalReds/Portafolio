...
const Project = forwardRef((props, ref)=> {
  ...
  const projects = [
    ...
    {title: "Poryecto Destacado", name: 'App de Rick and Morty', description:"Es una SPA donde el usuario tiene que logearse para poder ingresar. Puede obtener más de 800 cards de los distintos personajes de la serie. Puede realizar búsquedas por ID, filtrarlos por genero y guardar sus favoritos.", image: 'https://i.ibb.co/xgy2TjB/Rick.png', skills: ["React", "Redux", "NodeJS", "Express", "Sequelize"], url: 'https://wedevelop.vercel.app/', repositories: 'https://github.com/RonalReds/rick_and_morty-Ft45a' }
  ]
